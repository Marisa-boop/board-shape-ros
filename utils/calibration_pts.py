...
camera_matrix:
  rows: 3
  cols: 3
  data: [1728.27186,    0.     ,  569.30447,
            0.     , 1729.86488,  418.90675,
            0.     ,    0.     ,    1.     ]
distortion_model: plumb_bob
distortion_coefficients:
  rows: 1
  cols: 5
  data: [-0.080040, 0.468967, -0.012946, -0.002907, 0.000000]
rectification_matrix:
  rows: 3
  cols: 3
  data: [1., 0., 0.,
...
projection_matrix:
  rows: 3
  cols: 4
  data: [1742.42353,    0.     ,  568.86855,    0.     ,
            0.     , 1738.74546,  412.27837,    0.     ,
            0.     ,    0.     ,    1.     ,    0.     ]
"""
...
camera_matrix_data = np.array(
    [[1728.27186, 0.0, 569.30447], [0.0, 1729.86488, 418.90675], [0.0, 0.0, 1.0]],
    dtype=np.float32,
)
